...
function cvApp() {
    return {
        ...
        prepareAndShowExportModal() {
            this.jsonExportData = JSON.stringify({ contact: this.contact, resumeContent: this.resumeContent }, null, 2);
            this.showExportModal = true;
        },

        copyToClipboard(event) {
            navigator.clipboard.writeText(this.jsonExportData).then(() => {
...
window.cvApp = cvApp;
window.hoverState = hoverState;
>>>>>>> c4b9ce6f7778185878de0c2941ea982ba27fd1ff
